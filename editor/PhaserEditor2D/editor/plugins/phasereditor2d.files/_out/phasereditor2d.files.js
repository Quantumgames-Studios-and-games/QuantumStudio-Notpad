                        ...
                        manager.add({
                            ...
                            handler: {
                                executeFunc: args => {
                                    ...
                                    viewer.setStyledLabelProvider(new ui.viewers.FileStyledLabelProvider());
                                    viewer.setCellRendererProvider(new ui.viewers.FileCellRendererProvider());
    ...
    (function (files) {
        ...
        (function (ui) {
            ...
            (function (viewers) {
                ...
                viewers.FileStyledLabelProvider = FileStyledLabelProvider;
            })(viewers = ui.viewers || (ui.viewers = {}));
        })(ui = files.ui || (files.ui = {}));
    })(files = phasereditor2d.files || (phasereditor2d.files = {}));
})(phasereditor2d || (phasereditor2d = {}));
    ...
    (function (files) {
        ...
        (function (ui) {
            ...
            (function (views) {
                ...
                ContentTypeSectionExtension.POINT_ID = "phasereditor2d.files.ui.views.ContentTypeSectionExtension";
            ...
            (function (views) {
                ...
                class FilesView extends ide.ViewerView {
                    ...
                    createPart() {
                        ...
                        viewer.repaint();
                        viewer.eventOpenItem.addListener((file) => {
                            if (file.isFolder()) {
                ...
                FilteredContentProvider._cache = new Map();
            })(views = ui.views || (ui.views = {}));
        })(ui = files.ui || (files.ui = {}));
    })(files = phasereditor2d.files || (phasereditor2d.files = {}));
})(phasereditor2d || (phasereditor2d = {}));
