...
(function (colibri) {
    class Plugin {
        ...
        getThemeIcon(name, theme) {
            const x2 = colibri.ui.controls.ICON_SIZE === 32;
        ...
        getIcon(name, common = false) {
            ...
            const image = new colibri.ui.controls.IconImage(this, name, common);
    ...
    class ColibriPlugin extends colibri.Plugin {
        ...
        registerExtensions(reg) {
            ...
            reg.addExtension(colibri.ui.ide.IconLoaderExtension.withPluginFiles(this, [
                ...
                colibri.ICON_FILE,
                colibri.ICON_FOLDER,
                colibri.ICON_ZOOM_RESET,
                colibri.ICON_ZOOM_IN,
                colibri.ICON_ZOOM_OUT,
                colibri.ICON_MENU,
                colibri.ICON_SMALL_MENU,
                colibri.ICON_CHECKED,
                colibri.ICON_CONTROL_CLOSE,
                colibri.ICON_CONTROL_TREE_COLLAPSE,
                colibri.ICON_CONTROL_TREE_EXPAND,
                colibri.ICON_CONTROL_TREE_EXPAND_LEFT,
                colibri.ICON_CONTROL_TREE_COLLAPSE_LEFT,
                colibri.ICON_CONTROL_SECTION_COLLAPSE,
                colibri.ICON_CONTROL_SECTION_COLLAPSE_LEFT,
                colibri.ICON_CONTROL_SECTION_EXPAND,
            ]));
            // themes
...
(function (colibri) {
    ...
    (function (ui) {
        ...
        (function (controls) {
            class IconImage {
                constructor(plugin, name, common) {
                    this._plugin = plugin;
                    this._name = name;
                    if (common) {
                                ...
                                if (e.code === "Escape") {
                                    if (Dialog._dialogs.length > 0) {
                                        ...
                                        if (dlg.isCloseWithEscapeKey()) {
                                            if (controls.Menu.getActiveMenu()) {
                                                controls.Menu.getActiveMenu().closeAll();
                                            }
                                            else {
                                                e.preventDefault();
                                                e.stopImmediatePropagation();
        ...
        (function (controls) {
            ...
            (function (viewers) {
                class TreeViewerRenderer {
                    ...
                    renderStyledLabel(args, x, y, styledProvider) {
